...
constexpr std::pair<PacketEnumT, PropertyMetadata<PropEnumT, PacketEnumT>> __build_entry(
...
constexpr std::pair<PacketEnumT, PropertyMetadata<PropEnumT, PacketEnumT>> __meta_entry_m(
...
constexpr std::pair<PropEnumT, PropertyMetadata<PropEnumT>> define_meta_entry(
...
template<typename PropEnumT, typename PacketEnumT, typename... Members,
        typename = std::enable_if_t<std::is_enum_v<PropEnumT> && std::is_enum_v<PacketEnumT>>>
constexpr std::pair<PacketEnumT, PropertyMetadata<PropEnumT, PacketEnumT>> define_meta_entry(
